...
- Use a [roomPosition](/RoomPosition) as a target, and only begin your in-room logic once you have moved 'in range' (away from exit tiles) of the desired position
