...
CPU Unlocks allow for a user to unlock their full CPU as determined by their [GCL](/Global_Control_Level) and [Shard](/Shard) limitations for 24 hours. They can be purchased via the Screeps store, Steam and through the in-game market via credits.
