...
Known as InterSharding, you first need to insure you have [CPU](/CPU) allocated to the new shard before starting. Then to send a [creep](/Creep) to another shard you first need to find a [highway](/Map#room) room at a crossroads that contains an [interShard Portal](/StructurePortal). The creep then must step on the portal and they will be transported to the new shard.
