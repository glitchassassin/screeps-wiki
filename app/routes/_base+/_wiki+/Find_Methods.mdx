...
Returns an array of directional exit constants (e.g. FIND_EXIT_TOP) or an integer error value if there is no path or you pass an invalid argument. This is typically used in conjunction with another find method to get specific [RoomPositions](/RoomPosition) matching the returned exit constants.
